...
- q2: individuals in the second quartile of distance  
- q3: individuals in the third quartile of distance  
- q4: individuals in the fourth quartile of distance (equivalent to sampling 10,000 individuals from ALL)   
...
The same pattern holds that the more variance a constrast explains in a given GWAS, the lower the error. 
